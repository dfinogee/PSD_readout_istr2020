...
The distribution of mPSD energy deposition in first two sections in events constructed is shown in figure~\ref{fig:7} (left). The right side of figure~\ref{fig:7} shows the energy profile in the mPSD sections.
